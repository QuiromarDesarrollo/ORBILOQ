#!/usr/bin/env bash
# ============================================================================
# ORBILOQ WMS - Filtros en toda la tabla de Bodega, historico de no conforme,
# fecha esperada/dias faltantes reales, retardo activado, quitar ENTREGA (v29)
# Requiere haber corrido antes orbiloq_wms_historico_no_conforme.sql
# Ejecutar DESDE LA RAIZ del repo:
#   bash apply_filtros_historico_v29.sh
# ============================================================================
set -e
...
echo "Aplicando filtros completos + historico + fechas reales..."
