#!/usr/bin/env bash
# ============================================================================
# ORBILOQ WMS - Simplifica el resultado de la importacion (v4)
# Requiere haber corrido antes apply_importador_excel_v3.sh
# Ejecutar DESDE LA RAIZ del repo:
#   bash apply_importador_excel_v4_simplificacion.sh
# ============================================================================
set -e
...
echo ""
echo "Listo. IMPORTANTE: tambien debes volver a correr en Supabase"
echo "el archivo orbiloq_wms_rpc_importador.sql actualizado (SQL Editor -> Run)."
echo ""
echo "Siguiente paso:"
