#!/usr/bin/env bash
# ============================================================================
# ORBILOQ WMS - "Quien recibio" en Producto no conforme (Logistica y Produccion) (v1)
# Complementa el SQL ya ejecutado (personal_logistica, registrar_no_conforme,
# liberar_no_conforme) con los cambios correspondientes en la app Flutter.
# Ejecutar DESDE LA RAIZ del repo:
#   bash apply_recibido_no_conforme_v1.sh
# ============================================================================
set -e
...
echo "Aplicando cambios de quien-recibio en producto no conforme..."
