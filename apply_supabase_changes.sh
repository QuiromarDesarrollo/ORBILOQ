#!/usr/bin/env bash
# ============================================================================
# ORBILOQ WMS - Aplica los cambios de conexion a Supabase sobre el repo actual
# Ejecutar DESDE LA RAIZ del repo (donde esta pubspec.yaml), en Git Bash:
#   bash apply_supabase_changes.sh
# ============================================================================
set -e
...
echo "  flutter test"
echo "  git status   (para revisar los cambios antes de subirlos)"
